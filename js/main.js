	...
	.controller('MainController', function($scope, $document, $filter, $location, $http, $rootScope, $state, $window, $timeout) {
        ...
        $scope.menu = {
            burgers: [
                ...
                {
                    name: "Мексиканський",
                    desc: "Булка з сезамом, котлета з яловичини приготована на вугіллі з цибулею на грилі, гострим перцем, листям салату, подвійним американським сиром чедар і соусом",
                    img: "img/burger4.png",
                    price: 85,
                    qty: 0,
                    doneness: [],
                ...
                },
                {
                    ...
                    desc: "Булка з сезамом, котлета з яловичини приготована на вугіллі з класичним барбек’ю соусом, цибулею на грилі, листям салату, хрумким бейконом, сиром чедар і домашнім майонезом",
                    img: "img/burger5.png",
                    price: 85,
                    qty: 0,
                    doneness: [],
